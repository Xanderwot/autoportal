...
describe MarksController do
  ...
  describe "GET new" do
    it "assigns a new mark as @mark" do
      ...
      assigns(:mark).should be_a_new(Mark)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created mark as @mark" do
        post :create, {:mark => valid_attributes}, valid_session
        assigns(:mark).should be_a(Mark)
        assigns(:mark).should be_persisted
      end

      it "redirects to the created mark" do
        post :create, {:mark => valid_attributes}, valid_session
        response.should redirect_to(Mark.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved mark as @mark" do
        ...
        Mark.any_instance.stub(:save).and_return(false)
        post :create, {:mark => {}}, valid_session
        assigns(:mark).should be_a_new(Mark)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested mark" do
        mark = Mark.create! valid_attributes
        # Assuming there are no other marks in the database, this
        # specifies that the Mark created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Mark.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => mark.to_param, :mark => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the mark" do
        mark = Mark.create! valid_attributes
        put :update, {:id => mark.to_param, :mark => valid_attributes}, valid_session
        response.should redirect_to(mark)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the mark as @mark" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Mark.any_instance.stub(:save).and_return(false)
        put :update, {:id => mark.to_param, :mark => {}}, valid_session
        assigns(:mark).should eq(mark)
      end
